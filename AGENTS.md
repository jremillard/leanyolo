...
- Weight loading: verify `get_model(name, weights="DEFAULT", class_names=coco80_class_names())` works for all variants without errors; review missing/unexpected key warnings.
