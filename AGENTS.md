...
- Weight loading: verify `get_model(name, weights="DEFAULT", num_classes=80, in_channels=3)` works for all variants without errors; review missing/unexpected key warnings.
