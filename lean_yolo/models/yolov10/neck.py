...
class YOLOv10Neck(nn.Module):
    def __init__(self, width_mult: float = 1.0, depth_mult: float = 1.0, max_channels: int = 1024, c3: int = 128, c4: int = 256, c5: int = 512):
        super().__init__()
        ...
        # P5 -> P4
        self.p5_p4_c2f = C2f(c5 + c4, c(256), n=d(1))
        # P4 -> P3
        self.p4_p3_c2f = C2f(c(256) + c3, c(128), n=d(1))
        # P3 -> P4
        self.p3_down = Conv(c(128), c(128), 3, 2)
        self.p3_p4_c2f = C2f(c(128) + c(256), c(256), n=d(1))
        # P4 -> P5
        self.p4_down = SCDown(c(256), c(256), 3, 2)
        self.p4_p5_c2f = C2fCIB(c(256) + c5, c(512), n=d(1))
