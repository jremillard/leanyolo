...
def coco80_class_names() -> List[str]:
    """Return the standard 80 COCO class names in YOLO order.

    This ordering matches common pretrained weights and visualization helpers.
    """
    return [
