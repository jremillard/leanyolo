...
This script reads the target mAP50-95 from references/yolov10/THU-MIG.yoloe/logs/<model>.csv and
...
def read_official_map(model: str) -> float:
    csv_path = Path("references/yolov10/THU-MIG.yoloe/logs") / f"{model}.csv"
